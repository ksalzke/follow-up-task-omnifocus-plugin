...
(function () {
    var action = new PlugIn.Action(function (selection, sender) {
        return __awaiter(this, void 0, void 0, function () {
            var selectedTask, newTaskDetails, dependencyPlugIn, dependencyLibrary, moveToActionGroupPlugIn, moveToActionGroupLibrary, form, dependencies, dependencyString, prerequisites, prereqString, newTaskForm, editForm, newTask, _i, prerequisites_1, prereq, _a, dependencies_1, dep, proj;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        selectedTask = selection.tasks[0];
                        newTaskDetails = {
                            note: selectedTask.note,
                            tags: selectedTask.tags,
                            flagged: selectedTask.flagged,
                            deferDate: selectedTask.deferDate,
                        ...
                        form = new Form();
                        dependencies = dependencyLibrary ? dependencyLibrary.getDependents(selectedTask) : [];
                        dependencyString = dependencies.length > 0 ? "\n\n DEPENDENT: \n - " + dependencies.map(function (task) { return task.name; }).join('\n - ') : '\n\nDEPENDENT: None';
                        prerequisites = dependencyLibrary ? dependencyLibrary.getPrereqs(selectedTask) : [];
                    ...
                    case 2:
                        _b.sent();
                        newTaskDetails.tags = newTaskForm.values.tags ? selectedTask.tags : [];
                        newTaskDetails.flagged = newTaskForm.values.flagged ? selectedTask.flagged : false;
                        newTaskDetails.deferDate = newTaskForm.values.deferDate ? selectedTask.deferDate : null;
                        newTaskDetails.dueDate = newTaskForm.values.dueDate ? selectedTask.dueDate : null;
                        newTaskDetails.note = newTaskForm.values.notes ? selectedTask.note : null;
                        _b.label = 3;
                    case 3:
                        editForm = new Form();
                        if (moveToActionGroupPlugIn)
                    ...
                    case 6:
                        _b.sent();
                        return [4 /*yield*/, dependencyLibrary.removeDependency(prereq.id.primaryKey, selectedTask.id.primaryKey)];
                    case 7:
                        _b.sent();
                        _b.label = 8;
                    case 8:
                    ...
                    case 11:
                        _b.sent();
                        return [4 /*yield*/, dependencyLibrary.removeDependency(selectedTask.id.primaryKey, dep.id.primaryKey)];
                    case 12:
                        _b.sent();
                        _b.label = 13;
                    case 13:
